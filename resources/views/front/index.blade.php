			...
			<section class="posts col-md-9">
				...
				<article class="post clearfix">
					<a href="#" class="thumb pull-left">
						<img class="img-thumbnail" src="images/news1.jpg" alt="">
					</a>
					<h2 class="post-title">
						<a href="#">Ir a Noticia1</a>
					</h2>
					<p>
				...
				<article class="post clearfix">
					<a href="#" class="thumb pull-left">
						<img class="img-thumbnail" src="images/news2.jpg" alt="">
					</a>
					<h2 class="post-title">
						<a href="#">Ir a Noticia2</a>
					</h2>
					<p>
						<span class="post-fecha">02/08/2016</span> por <span class="post-autor"><a href="#">Daniel Becerra</a></span>
					</p>
				...
				<article class="post clearfix">
					<a href="#" class="thumb pull-left">
						<img class="img-thumbnail" src="images/news3.jpg" alt="">
					</a>
					<h2 class="post-title">
						<a href="#">Ir a Noticia3</a>
					</h2>
					<p>
						<span class="post-fecha">02/08/2016</span> por <span class="post-autor"><a href="#">Daniel Becerra</a></span>
					</p>
